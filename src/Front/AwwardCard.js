...
function AwwardCard({data,index,groupData}) {
  ...
  return (
    <div className=' relative  w-auto h-screen my-1 flex justify-center items-center'  id={'section'+index}>
      <div className='relative  h-3/6  bg-rose-200 cursor-pointer' >
        <div 
          id="top" 
        ...
        <div 
          id="bottom"
          className={'bg--100 absolute p-6 h-full aspect-[10/8] rounded-md  bg-cover bg-no-repeat bg-center z-0 left-[50%]   transition-all '+ (active ? ' -translate-x-[15%] ' : '  -translate-x-[49%]  translate-y-[2%]')}
